...
fun ConfirmationInfo(
    ...
    Column(
        ...
        TitledText(
            ...
            text = confirmation.place.places.groupBy { it.row }
                .map {
                    stringResource(
        ...
        SmallTitle(
            text = stringResource(R.string.total_cost, confirmation.order.totalCost),
...
@Composable
private fun Confirmation.HallType.format(): String {
    return when (this) {
        Confirmation.HallType.RED -> stringResource(R.string.red_hall)
        Confirmation.HallType.GREEN -> stringResource(R.string.green_hall)
        Confirmation.HallType.BLUE -> stringResource(R.string.blue_hall)
        Confirmation.HallType.UNKNOWN -> stringResource(R.string.unknown_hall)
    }
}
